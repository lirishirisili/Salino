export const APP_LINK_HOST = 'hsr.lirshir.com';

export const APP_LINK_BASE_URL = `https://${APP_LINK_HOST}`;
...
export const buildInviteUrl = (code: string): string =>
  `${APP_LINK_BASE_URL}/join/${encodeURIComponent(code.trim().toUpperCase())}`;
